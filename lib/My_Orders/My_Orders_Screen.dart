...
class _My_Orders_ScreenState extends State<My_Orders_Screen> with SingleTickerProviderStateMixin {
  ...
  late String role_id,
      ...
      TotalAmount = "0",
      mobile_number;
  var OngoingOrderListRes, Past_OrderListRes;
  List Ongoing_OrderList=[];
  List Past_OrderList=[];
  bool isloader = false;
  @override
  void initState() {
        ...
        appBar: PreferredSize(
            ...
            child: CustomAppBar(
              ...
              titlename: 'My Order\'s',actionontap: (){Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => Categories_Screen()));},actionicon: 'assets/Menu_Icon/home_house.png', visible: true,)),
        drawer: DrawerScreen(),
        body: Column(
          children: [
            TabBar(
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: ListView.builder(
            itemCount: Ongoing_OrderList.length,
                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(child: SizedBox()),
                            Text('\u{20B9} ${Ongoing_OrderList[index]['Total Amount'].toString()}',style: TextStyle(color: ColorName.logocolor,fontWeight: FontWeight.w600,fontSize: 16),)
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        child: ListView.builder(
                            itemCount: Ongoing_OrderList[index]['Products'].length,
                            scrollDirection: Axis.vertical,
                            shrinkWrap: true,
                            ...
                            itemBuilder: (context, index2) {
                              return Row(
                                children: [
                                  Expanded(child: Text('\u2022  ${Ongoing_OrderList[index]['Products'][index2]['Product Name'].toString()}',textAlign: TextAlign.start),flex: 2),
                                  Expanded(child: Text('Qty: ${Ongoing_OrderList[index]['Products'][index2]['Quantity'].toString()}',textAlign: TextAlign.center)),
                                  Expanded(child: Text('\u{20B9} ${int.parse(Ongoing_OrderList[index]['Products'][index2]['Quantity'].toString()) * int.parse(Ongoing_OrderList[index]['Products'][index2]['Rate'].toString())}',textAlign: TextAlign.end,)),
                                ],
                              );
                            }),
                      ),
  ...
  Widget Past_Orders_ListUI() {
    return Padding(
      padding: const EdgeInsets.all(10.0),
      child: SingleChildScrollView(

        child: ListView.builder(
            itemCount: Past_OrderList.length,
            scrollDirection: Axis.vertical,
            shrinkWrap: true,
            itemBuilder: (context, index) {
              return Column(
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(child: SizedBox()),
                            Text('\u{20B9} ${Past_OrderList[index]['Total Amount'].toString()}',style: TextStyle(color: ColorName.logocolor,fontWeight: FontWeight.w600,fontSize: 16),)
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        child: ListView.builder(
                            itemCount: Past_OrderList[index]['Products'].length,
                            scrollDirection: Axis.vertical,
                            shrinkWrap: true,
                            physics: const NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index2) {
                              return Row(
                                children: [
                                  Expanded(child: Text('\u2022  ${Past_OrderList[index]['Products'][index2]['Product Name'].toString()}',textAlign: TextAlign.start),flex: 2),
                                  Expanded(child: Text('Qty: ${Past_OrderList[index]['Products'][index2]['Quantity'].toString()}',textAlign: TextAlign.center)),
                                  Expanded(child: Text('\u{20B9} ${int.parse(Past_OrderList[index]['Products'][index2]['Quantity'].toString()) * int.parse(Past_OrderList[index]['Products'][index2]['Rate'].toString())}',textAlign: TextAlign.end,)),
                                ],
                              );
                            }),
                      ),
  ...
  Future<void> Ongoing_OrdersListApi() async {
    ...
    apiService.callOngoing_OrderListApi(jsonparam, token).then((value) => {
      setState(() {
        print("Your Cart Responce : " + value.toString());
        OngoingOrderListRes = value;
        // YourCartListRes = json.decode(value);
        if (OngoingOrderListRes['status'].toString() == "success") {
          setState(() {
            Ongoing_OrderList = OngoingOrderListRes["Ongoing Order"];
            print("Ongoing Order List : " + Ongoing_OrderList.toString());

          });
          isloader = true;
          Fluttertoast.showToast(
              msg: OngoingOrderListRes['message'].toString(),
  ...
  Future<void> Past_OrdersListApi() async {
    Map<String, Object> jsonparam = Map();
    setState(() {
      jsonparam = {"mobile_number": mobile_number};
    });
    ...
    apiService.callPast_OrdersListApi(jsonparam, token).then((value) => {
      setState(() {
        print("Past Order Responce : " + value.toString());
        Past_OrderListRes = value;
        // YourCartListRes = json.decode(value);
        if (Past_OrderListRes['status'].toString() == "success") {
          setState(() {
            Past_OrderList = Past_OrderListRes["Past Order"];
            print("Past Order List : " + Past_OrderList.toString());

          });
          isloader = true;
          Fluttertoast.showToast(
              msg: Past_OrderListRes['message'].toString(),
              toastLength: Toast.LENGTH_LONG,
              gravity: ToastGravity.BOTTOM,
              timeInSecForIosWeb: 1,
              backgroundColor: ColorName.black,

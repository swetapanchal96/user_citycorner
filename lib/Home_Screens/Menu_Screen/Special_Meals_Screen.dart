...
import 'package:user_citycorner/Home_Screens/Menu_Screen/Your_Cart_Screen.dart';

class Special_Meals_Screen extends StatefulWidget {
  const Special_Meals_Screen({super.key});

  @override
  State<Special_Meals_Screen> createState() => _Special_Meals_ScreenState();
}

class _Special_Meals_ScreenState extends State<Special_Meals_Screen> {
    ...
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: CustomAppIconBar(
              ...
              titlename: 'Special Meals',actionontap: (){},actionicon: 'assets/Menu_Icon/shop_shopping.png',)
      ),
      body: Container(
        child: Column(
          children: [
                  ...
                  return InkWell(
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            //           child: Container(
                                            //             decoration: BoxDecoration(
                                            //               color: ColorName.Acceptbtncolor,
                                            //             ),
                                            //           ),
                                            //         ),
                                            //         Positioned(
                                            ...
                                            //           ),
                                            //         ),
                                            //         Positioned(right: 3,bottom: 5,
                                            //             child: Center(child: Text('\u{20B9} 150.00',style: TextStyle(color: ColorName.white),)))
                                            //
                                            //       ],
                                            //     ),
                                            //   ),
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column (
                                            ...
                                            children: [
                                              Text('Delux Thali - Veg',style: TextStyle(color: ColorName.black,fontSize: 16,fontWeight: FontWeight.bold),),
                                              SizedBox(height: 5,),
                                              Text('Shahi Paneer, Mix Veg, Dal Makhani, 3 Roti, Rice, Curd, Salad, Papad & Dessert.'),

                                              Row(
                                                children: [
                                                  Text("Quantity : ",style: TextStyle(color: ColorName.black,fontSize: 16,fontWeight: FontWeight.bold),),
                                                  QuantityInput(
                                                      value: selectQuantity,buttonColor: ColorName.logocolor,acceptsZero: false,readOnly: true,decoration: InputDecoration(contentPadding: EdgeInsets.zero,border: OutlineInputBorder(borderSide: BorderSide(width: 1))),
                                                      onChanged: (value) => setState(() => selectQuantity = int.parse(value.replaceAll(',', '')))
                                                  ),
                                                ],
                                              ),
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          borderRadius: BorderRadius.circular(5),
                                                          border: Border.all(width: 1,color: ColorName.black)
                                                      ),width: 120,
                                                    ),
                                                  ),
                                                  InkWell(
                                                    ...
                                                    onTap: (){
                                                      Navigator.of(context).push(MaterialPageRoute(
                                                          builder: (context) => Your_Cart_Screen()));
                                                    },borderRadius: BorderRadius.circular(5),

                                                    child: Container(
                                                      child: Padding(
                                                        padding: const EdgeInsets.only(top: 5.0,bottom: 5.0),
                                                        child: Text('Add to Cart',style: TextStyle(fontSize: 14,color: ColorName.white),),
                                                      ),alignment: Alignment.center,
                                                      decoration: BoxDecoration(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          ...
                          // borderRadius: BorderRadius.circular(5),
                          border: Border(bottom: BorderSide(color: ColorName.gray2,width: 1)),
                          // boxShadow: [
                          //   BoxShadow(
                          //       blurRadius: 3,
                          //       color: ColorName.gray2,
                          ...
                          children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '2 vegetable, Shahi Paneer, Mix Veg, Dal Makhani, 3 Roti, Rice, Curd, Salad, Papad & Dessert.',
                                          style: TextStyle(
                           ...
                           Column(
                             ...
                             children: [
                               ...
                               },backcolor: ColorName.logocolor,text: 'Add',textcolor: ColorName.logocolor,width: 80),
...
class CustomPath extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(size.width - 135, size.height / 2);

    ...
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: CustomAppIconBar(
            ...
            titlename: 'Your Cart',actionontap: (){},actionicon: 'assets/Menu_Icon/home_house.png',)
      ),
      body: Container(
            ...
            children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text('2 * Deluxe Thali-Veg $index',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                                    SizedBox(height: 5,),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      },backcolor: ColorName.logocolor,text: 'Add more items',textcolor: ColorName.logocolor,width: 120),
                      Text('Total: \u{20B9} 900.00',style: TextStyle(color: ColorName.black,fontWeight: FontWeight.bold,fontSize: 18),),
              ...
              Container(
                ...
                child: CustomSquareButton(onTap: (){Navigator.of(context).push(MaterialPageRoute(
                  ...
                  backcolor: ColorName.logocolor, text: 'Continue', textcolor: ColorName.white,
                ),
              )
